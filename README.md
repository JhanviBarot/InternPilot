...
**Test suite: 300 tests across 19 files.** All pass against a live PostgreSQL + pgvector instance.
...
| Tests | pytest + pytest-asyncio + httpx (300 tests) | Async-native; integration tests hit a real PostgreSQL instance |
...
|-------------|-------|--------|
| Test suite | 300 / 300 passing | `uv run pytest` |
...
tests/                      300 tests across 19 test files
scripts/
